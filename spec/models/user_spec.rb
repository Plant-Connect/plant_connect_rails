...
RSpec.describe User, type: :model do
  ...
  describe 'user creation' do 
    ...
    it 'does not create a User when email is already taken' do 
      user1 = User.create(username: 'Steven', email: 'steven@test.com', password: 'password123', password_confirmation: 'password123')
      user2 = User.create(username: 'Steven', email: 'steven@test.com', password: 'anotherpassword', password_confirmation: 'anotherpassword')
    ...
    it 'does not create a User when password and confirmation are not matching' do 
      user1 = User.create(username: 'Steven', email: 'steven@test.com', password: 'password123', password_confirmation: 'password123')
      user2 = User.create(username: 'Steven', email: 'anotheremail@test.com', password: 'anotherpassword', password_confirmation: 'thisisthewrongpassword')
