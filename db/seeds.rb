...
plant11 = Plant.create(photo: "https://images.pexels.com/photos/10891365/pexels-photo-10891365.jpeg", plant_type: "geranium", indoor: false, user_id: user11.id)
...
listing11 = Listing.create(quantity: 2, category: 'plant', rooted: true, user_id: user11.id, plant_id: plant11.id, description: "So stink, so beautiful. Geraniums", active: true)
